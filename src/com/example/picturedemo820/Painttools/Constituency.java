...
public class Constituency implements ToolInterface {
	...
	public Constituency(int color, Bitmap bitmap) {
		mBitmap = bitmap;
		...
		mDasedPaint.setDither(true);//抗抖动
		mDasedPaint.setAntiAlias(true);//无锯齿
		mDasedPaint.setStyle(Paint.Style.STROKE);//实现空心效果
	...
	public void draw(Canvas canvas) {
		if (null != canvas) {
			...
			canvas.drawRect(startx-1, starty-1, mCurrentX+1, mCurrentY+1, mFullDasedPaint);
		}
	}
